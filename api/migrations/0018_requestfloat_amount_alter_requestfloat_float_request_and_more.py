# Generated by Django 4.1.6 on 2024-01-25 16:10
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('api', '0017_remove_requestfloat_amount_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='requestfloat',
            name='float_request',
            field=models.CharField(default='Mtn', max_length=255),
        ),
        migrations.CreateModel(
            name='PayRequestedFloat',
            fields=[
                ...
                ('agent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_requesting_float', to=settings.AUTH_USER_MODEL)),
                ('float_request', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.requestfloat')),
            ],
        ),
    ]
