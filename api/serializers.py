...
class MomoWithdrawalSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id','agent','customer','network','amount','date_of_withdrawal','get_agents_phone','get_agent_username','d_200','d_100','d_50','d_20','d_10','d_5','d_2','d_1','total','customer_pic','get_customer_pic','amount_received']
        read_only_fields = ['agent']
