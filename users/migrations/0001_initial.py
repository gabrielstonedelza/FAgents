    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('Supervisor', 'Supervisor'), ('Agent', 'Agent'), ('Administrator', 'Administrator')], default='Agent', max_length=50)),
                ('email', models.EmailField(max_length=255, unique=True)),
                ('full_name', models.CharField(max_length=100)),
                ('phone_number', models.CharField(max_length=30, unique=True)),
                ('user_blocked', models.BooleanField(default=False)),
                ('supervisor', models.CharField(blank=True, default='admin', max_length=100)),
